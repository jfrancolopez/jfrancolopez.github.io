...
After reboot, here is the manual install w ML4W dot files
...
flatpak run com.ml4w.dotfileinstaller
#load configuration (rolling config below):
https://raw.githubusercontent.com/mylinuxforwork/dotfiles/main/hyprland-dotfiles.dotinst
#download files
#cp and paste -> open script
# after finish click next on the installer window
#follow prompt -> install and active
#reboot
